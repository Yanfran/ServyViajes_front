...
export class EditComponent {
    ...
    constructor(        
        ...
        if (!this.sharedData) {
            this._router.navigateByUrl('/mis-eventos');
        }
    }    
    ...
    async ngOnInit(): Promise<void> {    
        ...
        this.createForm = this._formBuilder.group({
            ...
            academic_grade_id: ['', Validators.required],
        ...
        if (this.sharedData) { 
            ...
            this.createForm.patchValue({              
                ...
                academic_grade_id: this.sharedData.academic_grade_id,         
            ...
            this.lista_grados = this.sharedData?.event?.grados ?? [];
    ...
    edit(): void {
        ...
        var datos = {
            ...
            academic_grade_id: this.createForm.value.academic_grade_id,          
