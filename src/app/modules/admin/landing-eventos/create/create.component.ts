...
export class CreateComponent {
    ...
    colorFondo: string = '#ff0000'; // Color por defecto
    dataSource = [];
    slug: string = '';
    ...
    create(): void {
        ...
        var datos = {
            ...
            banners: this.slidesBanners.map((slide) => slide.src),
            patrocinadores: this.slidesPatrocinadores.map((slide) => slide.src),
        };
        ...
        try {
            // Create category
            this._landingEventosService.store(datos).subscribe(
                // (response: any) => {
